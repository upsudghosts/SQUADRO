...
xterm -rightbar -fa dejavumono -fs 12 -title  "Sbeve" -geometry 90x26 -fg grey -bg black -e  "java -cp SquadroINAB.jar:commons-cli-1.4.jar iia.games.contest.Client -p 4536 -s localhost -c iia.games.squadro.ChallengerSquadro;bash" &
